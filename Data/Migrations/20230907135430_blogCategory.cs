...
namespace Data.Migrations
{
    ...
    public partial class blogCategory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BlogCategoryLanguageItems",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogCategoryLanguageItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogCategoryLanguageItems_BlogCategories_BlogCategoryID",
                        column: x => x.BlogCategoryID,
                        principalTable: "BlogCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogCategoryLanguageItems_BlogCategoryID",
