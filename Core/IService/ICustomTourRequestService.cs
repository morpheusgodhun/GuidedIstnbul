...
{
    public interface ICustomTourRequestService : IGenericService<CustomTourRequest>
    {
        public CustomMadeTourPostDto AddRequest(CustomMadeTourPostDto customTour);
        public CustomTourOfferCustomerAnswer AddCustomerAnswer(CustomTourOfferCustomerAnswer offerAnswer);
